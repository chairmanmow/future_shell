...
var DD_MSG_AREA_CHOOSER_VERSION = "1.05";
var DD_MSG_AREA_CHOOSER_VER_DATE = "2013-05-10";
...
function DDMsgAreaChooser()
{
  ...
  this.colors.areaNum = "nwh";
  this.colors.desc = "nc";
  this.colors.numItems = "bh";
  this.colors.header = "nyh";
  this.colors.subBoardHeader = "ng";
  this.colors.areaMark = "gh";
  this.colors.latestDate = "ng";
  this.colors.latestTime = "nm";
  // Highlighted colors (for lightbar mode)
  this.colors.bkgHighlight = "4"; // Blue background
  this.colors.areaNumHighlight = "wh";
  this.colors.descHighlight = "c";
  this.colors.dateHighlight = "wh";
  this.colors.timeHighlight = "wh";
  this.colors.numItemsHighlight = "wh";
  ...
  this.msgGrpListPrintfStr = "n " + this.colors.areaNum + "%" + this.areaNumLen
                            + "d " + this.colors.desc + "%-"
                            + this.msgGrpDescLen + "s " + this.colors.numItems
                            + "%" + this.numItemsLen + "d";
  this.msgGrpListHilightPrintfStr = "n" + this.colors.bkgHighlight + " "
                            + "n" + this.colors.bkgHighlight
                            + this.colors.areaNumHighlight + "%" + this.areaNumLen
                            + "d n" + this.colors.bkgHighlight
                            + this.colors.descHighlight + "%-"
                            + this.msgGrpDescLen + "s n" + this.colors.bkgHighlight
...
function DDMsgAreaChooser_writeKeyHelpLine()
{
   ...
   console.print("n7rb, rb, rENTERb, rHOMEb, rENDb, r#b, rNm)bext pg, rPm)brev pg, rFm)birst pg, rLm)bast pg, rQm)buit, r?   ");
}
...
{
  var descFormatStr = "ngSub-boards of h%-25s     "
...
function DDMsgAreaChooser_selectMsgArea_Lightbar()
{
   ...
   {
      console.clear("n");
      console.print("yhThere are no message groups.\r\np");
      return;
   }
...
function DDMsgAreaChooser_selectSubBoard_Lightbar(pGrpIndex, pMarkIndex)
{
   ...
   {
      console.clear("n");
      console.print("yhThere are no sub-boards in the chosen group.\r\np");
      return retObj;
   }
...
function DDMsgAreaChooser_selectMsgArea_Traditional()
{
   ...
   while (continueChoosingMsgArea)
   {
      ...
      this.ListMsgGrps();
      console.crlf();
      console.print("nbhþ ncWhich, hQncuit, or [h" +
                    +(bbs.curgrp+1) + "nc]: h");
...
function DDMsgAreaChooser_listSubBoardsInMsgGroup_Traditional(pGrpIndex, pMarkIndex, pSortType)
{
   ...
   if ((typeof(pSortType) == "string") && (pSortType != "") && (pSortType != "none"))
   {
      ...
      {
         console.crlf();
         console.print((subBoardArray[i].subBoardNum == highlightIndex) ? "n" + this.colors.areaMark + "*" : " ");
   ...
   else
   {
      for (var arrSubBoardNum in msg_area.grp_list[grpIndex].sub_list)
      {
         ...
         if (msgBase.open())
         {
            ...
            console.crlf();
            console.print((subBoardNum == highlightIndex) ? "n" + this.colors.areaMark + "*" : " ");
...
function DDMsgAreaChooser_updatePageNumInHeader(pPageNum, pNumPages, pGroup, pRestoreCurPos)
{
  ...
  {
    console.gotoxy(29, 1);
    console.print("n" + this.colors.header + pPageNum + " of " + pNumPages + ")   ");
  }
  else
  {
    console.gotoxy(51, 1);
    console.print("n" + this.colors.subBoardHeader + pPageNum + " of " + pNumPages + ")   ");
  }
...
function DDMsgAreaChooser_showHelpScreen(pLightbar, pClearScreen)
{
   if (pClearScreen)
      ...
      console.print("n");
   console.center("chDigital Distortion Message Area Chooser");
   console.center("kÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ");
   console.center("ncVersion g" + DD_MSG_AREA_CHOOSER_VERSION +
                  " wh(b" + DD_MSG_AREA_CHOOSER_VER_DATE + "w)");
   console.crlf();
   console.print("ncThis lets you choose a message sub-board.");
   console.crlf();
   console.print("First, a listing of message groups is displayed.  One can be chosen by typing");
   console.crlf();
   ...
   {
      console.crlf();
      console.print("ncThe lightbar interface also allows up & down navigation through the lists:");
      console.crlf();
      console.print("khÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ");
      console.crlf();
      console.print("nchUp arrownc: Move the cursor up one line");
      console.crlf();
      console.print("hDown arrownc: Move the cursor down one line");
      console.crlf();
      console.print("hENTERnc: Select the current group/sub-board");
      console.crlf();
      console.print("hHOMEnc: Go to the first item on the screen");
      console.crlf();
      console.print("hENDnc: Go to the last item on the screen");
      console.crlf();
      console.print("hFnc: Go to the first page");
      console.crlf();
      console.print("hLnc: Go to the last page");
      console.crlf();
   }
   ...
   console.crlf();
   console.print("khÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ");
   console.crlf();
   console.print("nch?nc: Show this help screen");
   console.crlf();
   console.print("hQnc: Quit");
   console.crlf();
}
...
function DDMsgAreaChooser_buildSubBoardPrintfInfoForGrp(pGrpIndex)
{
   ...
   if (typeof(this.subBoardListPrintfInfo[pGrpIndex]) == "undefined")
   {
      ...
      this.subBoardListPrintfInfo[pGrpIndex].highlightPrintfStr =
                              ...
                              + this.colors.descHighlight + "%-"
                              + this.subBoardListPrintfInfo[pGrpIndex].nameLen + "s n"
                              + this.colors.bkgHighlight
                              + this.colors.numItemsHighlight + "%"
                              + this.subBoardListPrintfInfo[pGrpIndex].numMsgsLen + "d n"
                              + this.colors.bkgHighlight
                              + this.colors.dateHighlight + "%" + this.dateLen + "s n"
                              + this.colors.bkgHighlight
                              + this.colors.timeHighlight + "%" + this.timeLen + "s";
   }
}

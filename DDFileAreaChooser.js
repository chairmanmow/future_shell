...
var DD_FILE_AREA_CHOOSER_VERSION = "1.05";
var DD_FILE_AREA_CHOOSER_VER_DATE = "2013-05-10";
...
function DDFileAreaChooser()
{
  ...
  this.fileLibHighlightPrintfStr = "n" + this.colors.bkgHighlight + " "
...
function DDFileAreaChooser_selectFileArea_Traditional()
{
   ...
   {
      console.clear("n");
      console.print("yhThere are no file libraries.\r\np");
      return;
   }
   ...
   while (continueChooseFileLib)
   {
      ...
      console.clear("n");
      this.ListFileLibs();
      console.print("nbhþ ncWhich, hQncuit, or [h" + +(bbs.curlib+1) +
                    "nc]:h ");
...
function DDFileAreaChooser_selectDirWithinFileLib_Traditional(pLibNumber, pSelectedDir)
{
   ...
   if (pLibNumber > 0)
   {
      ...
      console.print("nbhþ ncWhich, hQncuit, or [h" + defaultDir +
                    "nc]: h");
...
function DDFileAreaChooser_listDirsInFileLib_Traditional(pLibIndex, pMarkIndex)
{
   ...
   console.print(this.colors.fileAreaHdr + "Directories of h" +
...
{
  var descLen = 40;
  var descFormatStr = this.colors.fileAreaHdr + "Directories of h%-" + descLen + "s     n"
      ...
      switch (userInput)
      {
         ...
         default:
            ...
            if (userInput.match(/[0-9]/))
            {
               ...
               console.clearline("n");
               console.print("cChoose library #: h");
...
function DDFileAreaChooser_selectDirWithinFileLib_Lightbar(pLibIndex, pHighlightIndex)
{
   ...
   {
      console.clear("n");
      console.print("yhThere are no directories in the chosen library.\r\np");
      return retObj;
   }
...
function DDFileAreaChooser_updatePageNumInHeader(pPageNum, pNumPages, pFileLib, pRestoreCurPos)
{
  ...
  {
    console.gotoxy(67, 1);
    console.print("n" + this.colors.fileAreaHdr + pPageNum + " of " + pNumPages + ")   ");
  }
...
function DDFileAreaChooser_showHelpScreen(pLightbar, pClearScreen)
{
   if (pClearScreen)
      ...
      console.print("n");
   console.center("chDigital Distortion File Area Chooser");
   console.center("kÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ");
   console.center("ncVersion g" + DD_FILE_AREA_CHOOSER_VERSION +
                  " wh(b" + DD_FILE_AREA_CHOOSER_VER_DATE + "w)");
   console.crlf();
   console.print("ncThis lets you choose a file directory.");
   console.crlf();
   console.print("First, a listing of file libraries is displayed.  One can be chosen by typing");
   console.crlf();
   ...
   if (pLightbar)
   {
      ...
      console.crlf();
      console.print("hENTERnc: Select the current library/dir");
      console.crlf();

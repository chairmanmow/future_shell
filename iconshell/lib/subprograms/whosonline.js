...
try { load('iconshell/lib/subprograms/subprogram.js'); } catch (e) { }
...
WhoOnline.prototype._drawModalContents = function () {
	...
	if (m.leftFrame && m.rightFrame) {
		...
		line++;
		// Fields
		for (var key in USER_INFO_FIELDS) {
			if (!USER_INFO_FIELDS.hasOwnProperty(key)) continue; var label = USER_INFO_FIELDS[key]; var val;

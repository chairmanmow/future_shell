	...
	children: [
		{
			...
			get children() {
				...
				return getGamesMenuItems();
			}
		},
		{ label: "Messages", viewId:"view3",  type: "item", iconFile:"messages", action: function(){ bbs.exec_xtrn("ECREADER")} },
		{ label: "Files", viewId:"view4",   type: "item", iconFile:"folder", action:function(){ bbs.exec_xtrn("ANSIVIEW")} },
		{
			label: "Who",
			type: "folder",
			iconFile: "whosonline",

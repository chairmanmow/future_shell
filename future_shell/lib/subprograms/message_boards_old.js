...
//         if (!this._transitionFrame || this._transitionFrameLabel !== this._transitionLabel) {
//             this._renderTransitionOverlay();
//         } else {
//             if (!this._transitionFramePinned) {
//                 try { this._transitionFrame.top(); this._transitionFramePinned = true; } catch (_topErr) { }
//             }
//             try { this._transitionFrame.cycle(); } catch (_cycleErr) { }
//         }
//         if (typeof console !== 'undefined' && console && typeof console.cycle === 'function') {
//             try { console.cycle(); } catch (_e) { }
//         }
//         return;
//     }
...
//     if (this._transitionActive) return false;
//     if (!key) return true;
...
//     this._transitionLabel = '';
//     this._transitionFrameLabel = '';
//     this._transitionFramePinned = false;
//     this._transitionHost = null;
// }
...
//             if (!msg && this.threadHeaders && this.threadHeaders.length) {
//                 var idx = Math.min(Math.max(this.threadSelection || 0, 0), this.threadHeaders.length - 1);
//                 msg = this.threadHeaders[idx];
//             }
//             if (msg) this._renderReadView(msg);
//             break;
//         }
//             break;
//         case 'post':
...
//     this._beginViewTransition('Rendering groups...', { defer: true });
//     this._ensureFrames();
//     this._beginViewTransition();
//     try { this._destroyReadFrames && this._destroyReadFrames(); } catch (e) { }
//     this._destroyThreadUI();
//     this._clearIconGrid();
//     this._refreshTransitionOverlay();
//     try {
//         this.view = 'group';
...
//         iconFg: WHITE
//     });
//     if ((typeof this.curgrp !== 'number' || isNaN(this.curgrp)) && msg_area && msg_area.grp_list && msg_area.grp_list.length) {
//         var derived = this._syncSubState(this.cursub || this._lastActiveSubCode || bbs.cursub_code || null);
//         if (derived && typeof derived.groupIndex === 'number') this.curgrp = derived.groupIndex;
//     }
//     if (typeof this.curgrp !== 'number' || isNaN(this.curgrp) || this.curgrp < 0) this.curgrp = 0;
//     var grp = (msg_area && msg_area.grp_list) ? msg_area.grp_list[this.curgrp] : null;
//     if (!grp) grp = { sub_list: [] };
//     try {
...
//     this._beginViewTransition('Rendering threads...', { defer: true });
//     this._ensureFrames();
//     this._beginViewTransition();
//     try { this._destroyReadFrames && this._destroyReadFrames(); } catch (e) { }
...
//     if (!msg) return;
//     this._beginViewTransition('Rendering message...', { defer: true });
//     this.view = 'read';
//     this._releaseHotspots();
//     this._hotspotMap = {};
...
//         try { this._transitionFrame.close(); } catch (e) { }
//         this._transitionFrame = null;
//     }
//     this._transitionFramePinned = false;
//     this._transitionHost = null;
//     var host = this.outputFrame || this.hostFrame || this.parentFrame || this.rootFrame || null;
//     var preferred = this._getTransitionHostFrame();
...
//     var text = this._transitionLabel || 'Rendering...';
...
//         this._transitionFrameLabel = text;
//         this._transitionFramePinned = true;
//         this._transitionHost = host;
//         if (typeof host.cycle === 'function') {
//             try { host.cycle(); } catch (_hostCycleErr) { }
//         }
//     } catch (e) {
//         if (typeof log === 'function') {
//             try { log('MessageBoard: transition frame error ' + e); } catch (_l) { }
//         }
//         this._transitionFrame = null;
//         this._transitionFrameLabel = '';
//         this._transitionFramePinned = false;
...
//         this._transitionLabel = label || 'Rendering...';
//     } else if (typeof label === 'string' && label.length) {
//         this._transitionLabel = label;
//     }
...
//         return;
//     }
//     if (this._transitionHost && typeof this._transitionHost.is_open === 'boolean' && !this._transitionHost.is_open) {
//         this._renderTransitionOverlay();
//         return;
//     }
//     if (!this._transitionFramePinned) {
...
//     }
//     try { this._transitionFrame.cycle(); } catch (_cycleErr) { }
//     if (this._transitionHost && typeof this._transitionHost.cycle === 'function') {
//         try { this._transitionHost.cycle(); } catch (_hostErr) { }
//     }
//     if (typeof console !== 'undefined' && console && typeof console.cycle === 'function') {
...
//     if (iconBase) {
//         if (!this._Icon) {
//             try { this._Icon = load('future_shell/lib/shell/icon.js').Icon || Icon; }
//             catch (e) { try { load('future_shell/lib/shell/icon.js'); this._Icon = Icon; } catch (e2) { } }
//         }
//         if (this._Icon) {
//             var iconFrame = null;
//             var labelFrame = null;

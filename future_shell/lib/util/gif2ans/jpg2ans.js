...
function JPG2ANS(optsOrArgv) {
    ...
    function jpg() {
        ...
        try { load(js.exec_dir + "future_shell/lib/util/gif2ans/jpg_loader.js"); } catch (e) { try { load("/sbbs/exec/jpg_loader.js"); } catch (_) { throw "jpg_loader.js not found"; } }
...
if (typeof this === 'object') this.JPG2ANS = JPG2ANS;

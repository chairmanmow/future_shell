...
// Export constructor globally and as return value
var moduleExports = { AvatarsFloat: AvatarsFloat };
var _global = (typeof globalThis !== 'undefined') ? globalThis : (typeof js !== 'undefined' && js && js.global) ? js.global : undefined;
if (_global) {
	try { _global.AvatarsFloat = AvatarsFloat; } catch(e){}
	try {
		if (typeof _global.CanvasAnimations === 'object') {
			_global.CanvasAnimations.AvatarsFloat = AvatarsFloat;
		}
	} catch(e){}
}

...
// this is currently included in the main chshell program because i need to sort out some of the dependencies
// but my intention is to move it out so most of the chat functionality is contained in this file which is in the shell so it looks cleaner
// code wise and is easier to update one thing without breaking them all 
